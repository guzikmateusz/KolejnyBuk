                        ...
                        <form name="form" method="post" action="RegisterServlet" id="form" onsubmit="return validate()" novalidate>
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="password" name="password" class="form-control" id="password" style="width: 300px;" >
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="conpassword" class="form-control" style="width: 300px;">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="surname" class="form-control" style="width: 300px;">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="number" name="phone" class="form-control" style="width: 300px;">
                            ...
                            <button type="submit" value="Register" class="btn btn-primary" style="background-color: #fff200; color:black; font-weight: bold; height: 40px; width: 150px; ">ZAREJESTRUJ</button>
