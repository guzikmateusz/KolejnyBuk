         ...
         <div class="w-90 p-5" >
            ...
            <div class="row">
             ...
             <div class="col-lg-2">
                ...
                <div class="col-lg-9">
                    <h3 style="font-family: 'Audiowide'; color:#fff200; font-weight:bold" > PROMOCJE</h3>
                    ...
                    <div class="card mt-4" style="background-color: #fff200; color:#343a40; border-color:#fff200;">
                        <img class="card-img-top img-fluid" src="https://i.imgur.com/rmh6zfb.png" alt="">
                        <div class="card-body">
                            <h3 class="card-title" style="font-weight: bold">BONUS KOSZYKARSKI!</h3>
