    ...
    <body style="background-color:#000647;">
        ...
        <div class="w-90 p-5" >
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <h3 style="font-family: 'Audiowide'; color:#fff200; font-weight:bold" >STRONA G?�WNA</h3>
                    ...
                    <div class="card mt-4" style="background-color: #fff200; color:#343a40; border-color:#fff200;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Zarejestruj si? i dokonaj depozytu minimum 50 PLN wybieraj?c bonus z mno?nikiem. Odbierz r�wnowarto?? nawet 1000 PLN!</p>
                    ...
                    <div class="card mt-4" style="background-color: #fff200; color:#343a40; border-color:#fff200;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Wirtualne sporty inspirowane s? prawdziwymi sportami i przedstawiaj? komputerowo, losowo generowane wyniki, przetwarzane w animacj?. Wyniki generowane w przypadku sport�w wirtualnych oparte s? na statystykach zespo?�w/graczy oraz liczbach wybranych przez generator liczb losowych. Ogromna ilo?? zdarze?, dynamika, kr�tki czas zamkni?cia zdarzenia jak r�wnie? rozliczenia zak?adu to g?�wne atuty sport�w wirtualnych. Wielkie emocje gwarantowane!</p>
