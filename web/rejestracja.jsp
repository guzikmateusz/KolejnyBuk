        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div>
                        <h3 style="color:#fff200; font-weight:bold" >ZAREJESTRUJ SIĘ</h3>
                        <form name="sentMessage" method="post" action="login" id="contactForm" novalidate>
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="password" name="haslo" class="form-control" id="password" style="width: 300px;" >
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" name="imie" class="form-control" style="width: 300px;" >
                              ...
                              <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="nazwisko" class="form-control" style="width: 300px;" >
                            ...
                            <div class="control-group form-group">
                             ...
                             <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="telefon" class="form-control" style="width: 300px;" >  
                            ...
                            <button type="submit" value="Login" class="btn btn-primary" style="background-color: #fff200; color: #343a40; border: 0px;">ZAREJESTRUJ</button>

                        </form>
                        <br>
                        <span style="color:red"><%=(request.getAttribute("errMessageLogowanie") == null) ? "" : request.getAttribute("errMessageLogowanie")%></span>
                    </div>
                    <p style="color: white">JESTEŚ JUŻ ZAREJESTROWANY? <a href="logowanie.jsp" style="color:#fff200; font-weight: bold"> ZALOGUJ SIĘ</a>
                    <!-- /.card -->
